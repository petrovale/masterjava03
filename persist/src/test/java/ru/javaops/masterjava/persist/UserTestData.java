...
public class UserTestData {
    ...
    public static void init() {
        ...
        FULL_NAME = new User("Full Name", "gmail@gmail.com", UserFlag.active, KIV.getId());
        USER1 = new User("User1", "user1@gmail.com", UserFlag.active, MOW.getId());
        USER2 = new User("User2", "user2@yandex.ru", UserFlag.active, KIV.getId());
        USER3 = new User("User3", "user3@yandex.ru", UserFlag.active, MNSK.getId());
